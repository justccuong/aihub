/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 783d09d47264865a9d4da8f4272933e1)
// Runtime types generated with workerd@1.20251210.0 2025-12-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		AIHUB_KV: KVNamespace;
		NEXTJS_ENV: string;
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		AIHUB_DB: D1Database;
		AIHUB_RATE_LIMITER: RateLimit;
		WORKER_SELF_REFERENCE: Fetcher /* aihub */;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL">> {}
}
